...
<head>
    <title>Detail Merk Timbul</title>
...
<body>
    ...
    <center>
        <div class="header" style="background: aquamarine;">
            <h4 style="font-family: cursive;"> Merk Timbul Menarik Sesuai Keinginanmu!</h4>
        </div>
    </center>
    ...
    <div class="container">
        <div class="jumbotron">
            <div class="card" style="width: 50%;">
                <img class="gambar" src="image/merk timbul.jpg" class="card-img-top" alt="">
                <div class="card-body">
                    <h6 style="font-family: cursive;">
                        Menerima Pesanan <br> <b> Merk Timbul </b><br> berbagai bentuk
                    </h6>
                </div>
                </a>
            </div>
        ...
        <div class="row" style="margin-right: 10px;">
            <div class="col-md-4">
                <div class="card" style="width: 25rem;">
                    <img class="gambar" src="image/galvanil.jpg" class="card-img-top" alt="">
                    <div class="card-body">
                        <center>
                            <h7 class="card-title" style="font-family: cursive;">Tipe 01 (Galvanil)</h7> <br>
                            <h7 style="font-family: cursive;">
                                Teknik spray dan anti gores
                            </h7>
                        </center>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card" style="width: 25rem;">
                    <img class="gambar" src="image/stainless.jpg" class="card-img-top" alt="">
                    <div class="card-body">
                        <center>
                            <h7 class="card-title" style="font-family: cursive;">Tipe 02 (Stainless Steel)</h7> <br>
                            <h7 style="font-family: cursive;">
                                Anti karat dan mudah dibentuk
                            </h7>
                        </center>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card" style="width: 25rem;">
                    <img class="gambar" src="image/acrilic.jpg" class="card-img-top" alt="">
                    <div class="card-body">
                        <center>
                            <h7 class="card-title" style="font-family: cursive;">Tipe 03 (Acrylic / Mika)</h7> <br>
                            <h7 style="font-family: cursive;">
                                Warna lebih variatif dan dapat disisipkan lampu
                            </h7>
                        </center>
                    </div>
                </div>
